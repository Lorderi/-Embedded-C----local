...
int main (int argc, char **argv)
{
    ...
    // создание очереди, идентификатор очереди, флаги(что делать, создать или присоединиться), права доступа к файлу: create my client queue for receiving messages from server
	...
	/*буффер сообщения КЛИЕНТА бесконечный ввод*/
